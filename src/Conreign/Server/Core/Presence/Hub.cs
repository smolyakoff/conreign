...
using Conreign.Server.Contracts.Shared.Presence.Events;
...
public class Hub : IHub
{
    ...
    {
        get { return _state.Members.Values.All(m => m.ConnectionIds.Count == 0); }
    }
    ...
    public async Task Disconnect(Guid userId, string connectionId)
    {
